...
class MongoConfig {
    ...
    fun mongoTemplate(): MongoTemplate {
        val connectionString = "mongodb://127.0.0.1:27017/geography"
        return MongoTemplate(SimpleMongoClientDatabaseFactory(MongoClients.create(connectionString), "geography"))
    }
}
